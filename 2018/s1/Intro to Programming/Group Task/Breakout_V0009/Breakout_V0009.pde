...
color titleBack = color(234,10,2);
color titleBackHover = color(2,196,48);
...
void draw() {
  ...
  if (gameState == 0) {
    ...
    rect(titleStartX, titleStartY, titleStartWidth, titleStartHeight);
    ...
    rect(titleInstructX, titleInstructY, titleInstructWidth, titleInstructHeight);
    ...
    rect(titleSettingsX, titleSettingsY, titleSettingsWidth, titleSettingsHeight);
  ...
  //Instructions Page******************************************
    ...
    text("[Placeholder]",width/7,59*height/96+height/9);
    text("[Placeholder]",width/7,59*height/96+2*height/9);
    text("[Placeholder]",width/7+width/2,59*height/96);
    text("[Placeholder]",width/7+width/2,59*height/96+height/9);
    text("[Placeholder]",width/7+width/2,59*height/96+2*height/9);
    ...
    for (int i = 0; i < 2; i++) {
      for (int j = 0; j < 3; j++) {
        ...
        noStroke();
        rect(width/12+i*width/2,29*height/48+j*height/9,width/10,height/20);
      }
    }
  } 
...
void createBrick(int colour, int xRel, int yRel) {
  ...
  rect(xRel*width/10+width/20,yRel*height/20+height/10,width/10,height/20);
...
void backButton() {
  ...
  rect(titleBackX, titleBackY, titleBackWidth, titleBackHeight);
